 ...
 */
declare class WebSecureStorage implements SecureStorageAdapter {
    private dbName;
    private storeName;
    private version;
    private db;
 ...
 */
declare class WebAsyncStorage implements AsyncStorageAdapter {
    private prefix;
    /**
...
export { ACCOUNT_CLASS_HASHES, type AccountDeploymentData, type AccountType, type AegisConfig, AegisError, AegisErrorCode, AegisErrorFactory, AegisErrorType, AegisSDK, type AegisWallet, type AsyncStorageAdapter, BackendClient, type ExecuteOptions, InAppWallet, type InternalAegisConfig, KeyManager, type KeyMetadata, NetworkManager, ReactNativeAsyncStorage, ReactNativeSecureStorage, type SecureStorageAdapter, type StorageCapabilities, StorageManager, type TokenBalance, type TransactionResult, type WalletConnectionData, WalletManager, WebAsyncStorage, WebSecureStorage, deriveAddressFromPublicKey, estimateDeploymentFee, expandConfigWithDefaults, generateAccountAddress, generateMultipleAccountAddresses, getAccountClassHash, getConstructorCalldata, getPublicKeyFromPrivateKey, getSupportedAccountTypes, isAccountTypeSupported, isValidAccountAddress, normalizePrivateKey, prepareDeploymentData, validateAccountClassHash, validateAegisConfig, validateCallData, validateDeploymentData, validateInternalConfig, validatePrivateKey, validateStarknetAddress };
